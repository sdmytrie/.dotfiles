...
define(['fs', 'path', 'typescript/lib/tsserverlibrary', 'vscode-languageserver/node', 'vscode-jsonrpc', 'vscode-languageserver-protocol', 'vscode-languageserver', 'vscode-uri', 'child_process'], function (fs, path, tsserverlibrary, node, vscodeJsonrpc, vscodeLanguageserverProtocol, vscodeLanguageserver, vscodeUri, child_process) { 'use strict';
  ...
  `;
	 ...
	 */
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Version = exports.resolveNgLangSvc = exports.resolveTsServer = exports.resolve = exports.NGLANGSVC = void 0;
	...
	class Session {
	    ...
	    checkIsAngularProject(project) {
	        ...
	        const isAngularProject = project.hasRoots() && !project.isNonTsProject() && ngCoreDts !== undefined;
	        if (isAngularProject) {
	            return ngCoreDts;
	        }
	        project.disableLanguageService();
	...
	const host = new server_host.ServerHost(options.ivy);
